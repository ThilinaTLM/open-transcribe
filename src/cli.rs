...
pub enum Commands {
    ...
    Download {
        #[arg(help = "Model to download (e.g., tiny, base, small, medium, large-v3)")]
        model: String,

        #[arg(help = "Directory to download model to (defaults to current directory)")]
